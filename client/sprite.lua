...
createSheet(1, assets.files["skin1.png"], {
	...
	clears = 57,
	[57] = {768, 48 * 0, 256, 48}, -- single
	[58] = {768, 48 * 1, 256, 48}, -- double
	[59] = {768, 48 * 2, 256, 48}, -- triple
	[60] = {768, 48 * 3, 256, 48}, -- quad
	
	tricks = 61,
	[61] = {768, 48 * 4, 256, 48}, -- tspin
	[62] = {768, 48 * 5, 256, 48}, -- mini tspin
	[63] = {768, 48 * 6, 256, 48}, -- b2b
	[64] = {768, 48 * 7, 256, 48}, -- combo
	...
	phase = 67,
	[67] = {512, 512 + 64*2, 512, 64}, -- ready
	[68] = {512, 512 + 64*3, 512, 64}, -- go
	[69] = {448, 0, 320, 64}, -- players remaining
	[70] = {512, 512 + 64*4, 512, 64}, -- victory
